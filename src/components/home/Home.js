    ...
    return (
      <Container>
          <div style={{display: 'flex', flexDirection: 'row', alignSelf: 'center', marginTop: '5rem', marginBottom: '5rem', justifyContent: 'space-evenly', flexWrap: 'wrap'}}>
            <div>
              <img src={logo} style={{maxWidth: '200px', maxHeight: '200px'}}></img>
            </div>
        ...
        <div style={{position: 'relative', paddingBottom: '56.25%', height: 0}}>
          <iframe style={{position: 'absolute', top: '0', left: '0', width: '100%', height: '100%'}} src="https://www.youtube.com/embed/7VL3kqI8CxY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <Spacer></Spacer>
        ...
        <div style={{backgroundColor: '#ffebce', padding: '5rem', textAlign: 'center', position: 'relative'}}>
          ...
          <img src={badge} style={{maxWidth: '100px', maxHeight: '100px', position: "absolute", right: '50px', top: '-50px'}}></img>
        </div>
        <Spacer></Spacer>
        <div style={{backgroundColor: '#ffebce', padding: '5rem', textAlign: 'center', position: 'relative'}}>
          ...
          <img src={badgeRed} style={{maxWidth: '100px', maxHeight: '100px', position: "absolute", left: '50px', bottom: '-50px'}}></img>
        </div>
